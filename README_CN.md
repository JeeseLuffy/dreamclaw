# DreamClaw: 情感驱动的社交 AI 代理

DreamClaw（代码包名：`dclaw`）是一个拥有**个性、记忆和约束**的自主社交代理。与传统的聊天机器人不同，DreamClaw 使用循环状态机、6维情感向量和“超我”批评家机制，以确保产生高质量、拟人化的互动。
